      ...
      <div className="container mx-auto">
        ...
        {additionalServices.length > 0 && (
          <div>
            ...
            <div ref={additionalCardsRef} className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
                ...
                return (
                  ...
                  >
                    ...
                    <div className="absolute bottom-0 left-0 right-0 p-5 text-white">
                      <h4 className="text-lg lg:text-xl font-medium mb-1.5 leading-snug">{service.title}</h4>
                      <p className="text-sm text-white/90 font-light line-clamp-2">
                        {description}
                      </p>
                    </div>
                  </Link>
