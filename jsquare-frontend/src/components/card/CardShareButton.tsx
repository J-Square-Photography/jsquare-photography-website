...
export function CardShareButton({ url, name }: CardShareButtonProps) {
  ...
  return (
    <button
      ...
      style={{ borderColor: 'var(--secondary, #6b7280)', color: 'var(--secondary, #6b7280)' }}
    >
      <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" style={{ color: 'var(--secondary, #6b7280)' }}>
