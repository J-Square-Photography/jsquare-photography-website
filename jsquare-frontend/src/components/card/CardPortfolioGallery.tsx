    ...
    <div>
      ...
      <div className="grid grid-cols-2 gap-2">
        {images.map((img) => (
          ...
          >
            <Image src={img.image_url} alt={img.caption || 'Portfolio'} fill quality={90} sizes="(max-width: 768px) 50vw, 25vw" className="object-cover transition group-hover:scale-105" />
          </button>
        ))}
      </div>
